...
int valid_instruction(Word instruction) {
  ...
  if (temp == 0) {
    ...
    return 1;
	     ...
	     (temp3 >= 0 && temp3 <= 11)) {
    return 1;
  } else if ((temp == 7) && (temp_instruct >= 0 && temp_instruct <= 49151) &&
	     (temp_instruct % 4 == 0)) {
    return 1;
  } else if ((temp == 8) && (temp_instruct >= 0 && temp_instruct <= 49151) &&
	     (temp_instruct % 4 == 0)) {
    return 1;
  } else if ((temp == 9) && (temp_instruct >= 0 && temp_instruct <= 49151) &&
	     (temp_instruct % 4 == 0)) {
    return 1;
